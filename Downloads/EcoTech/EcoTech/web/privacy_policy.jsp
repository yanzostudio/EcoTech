<%-- 
    ...
    Created on : Jan 23, 2025, 12:31:42 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Privacy Policy</title>
...
<div class="container-fluid feature bg-light py-3">
    <div class="container py-5">
        ...
        <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <p>We value your privacy and are committed to protecting your personal data. Please read our privacy policy carefully to understand how we collect, use, and protect your information.</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.4s">
                <h4 class="text-primary">1. Information We Collect</h4>
                <p>We collect personal data such as your name, email, phone number, and other relevant information that you provide when using our platform. This information helps us improve our services.</p>
            </div>

            <!-- Section 2 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.6s">
                <h4 class="text-primary">2. How We Use Your Data</h4>
                <p>Your personal data is used to provide and improve our services, communicate with you, and keep you informed about updates. We do not sell or share your data with third parties without your consent.</p>
            </div>

            <!-- Section 3 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.8s">
                <h4 class="text-primary">3. Data Protection</h4>
                <p>We implement robust security measures to protect your personal data from unauthorized access, alteration, or disclosure. However, no method of transmission over the internet is 100% secure.</p>
            </div>

            <!-- Section 4 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="1s">
                <h4 class="text-primary">4. Your Rights</h4>
                <p>You have the right to access, correct, and delete your personal information. You can contact us to update your data or to request its deletion at any time.</p>
            </div>

            <!-- Section 5 -->
            <div class="col-lg-12 wow fadeInUp" data-wow-delay="1.2s">
                <h4 class="text-primary">5. Changes to this Privacy Policy</h4>
                <p>We may update this privacy policy periodically to reflect changes in our practices or legal requirements. We will notify you of any significant changes through email or our platform.</p>
            </div>
        </div>

        <!-- Footer Note -->
        <div class="text-center mt-5 wow fadeInUp" data-wow-delay="1.4s">
