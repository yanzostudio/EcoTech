<%-- 
    Document   : carbon_tracking
    Created on : Jan 23, 2025, 12:16:15 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Carbon Tracking</title>
        ...
        <div class="container-fluid position-relative p-0">
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Carbon Tracking</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                        <li class="breadcrumb-item"><a href="sustainabilities.jsp">Sustainability</a></li>
                        <li class="breadcrumb-item active text-primary">Carbon Tracking</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
            ...
            <div class="container py-5 text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                        <i class="fas fa-leaf display-1 text-danger"></i>
                        <h1 class="display-4 mb-4">Carbon Tracking</h1>
                        <p class="mb-4">
                            Carbon tracking enables businesses and individuals to monitor and reduce their carbon footprint. 
                            Learn about the tools and methods to achieve a sustainable lifestyle.
                        </p>
                        <div class="row text-start justify-content-center">
                            <div class="col-md-6 mb-4">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-chart-pie text-danger fa-2x me-3"></i>
                                    <div>
                                        <h5 class="mb-1">Emission Reports</h5>
                                        <p class="mb-0">Detailed tracking and reporting of greenhouse gas emissions.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
