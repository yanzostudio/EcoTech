<%-- 
    Document   : about
    Created on : Jan 23, 2025, 12:09:22 AM
    Author     : USER
--%>
                    ...
                    <div class="row g-4 justify-content-center">
                        <div class=" col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="feature-item p-4">
                                ...
                                <a href="#" class="h4 mb-3">About Us</a>
                                <p> </p>
                                <p> </p>
                                <a href="aboutus.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-bullseye text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-1">Sustainability Goals</a>
                                <p style="margin-bottom: 10 px;"> </p>
                                ...
                                <a href="sustainability_goals.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
