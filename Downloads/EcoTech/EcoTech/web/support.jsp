        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="login.jsp" class="btn btn-primary rounded-pill d-inline-flex flex-shrink-0 py-2 px-4 ms-3">Login</a></div>
            </nav>

            <!-- Header Start -->
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Support</h4>
                    ...
                    <div class="row g-4 justify-content-center">
                        <div class=" col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-info text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Help Center</a>
                                ...
                                <a href=".html" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                        <!--<div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-book text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Documentation</a>
                                ...
                                <a href="carbon_tracking.html" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>-->
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-phone text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Contact Us</a>
                        ...
                        <!--<div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-school text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Training</a>-->
                                <!--<p class="mb-3">Promoting sustainable water management practices to ensuring long-term availability of ecosystem</p>-->
                                <!--<a href="water_conservation.html" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>--->
                    </div>
                </div>
