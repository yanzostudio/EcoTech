<%-- 
    Document   : water_conversation
    Created on : Jan 23, 2025, 12:49:21 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Water Conservation</title>
        ...
        <div class="container-fluid position-relative p-0">
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Water Conservation</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                        <li class="breadcrumb-item"><a href="sustainabilities.jsp">Sustainability</a></li>
                        <li class="breadcrumb-item active text-primary">Water Conservation</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
            ...
            <div class="container py-5 text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                        <i class="fas fa-water display-1 text-info"></i>
                        <h1 class="display-4 mb-4">Water Conservation</h1>
                        <p class="mb-4">
                            Water conservation practices are essential to preserve this vital resource. Explore ways to reduce water consumption and optimize its use.
                        </p>
                        <div class="row text-start">
                            <div class="col-md-6 mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">Smart Irrigation</h5>
                                        <p class="mb-0">Efficient watering solutions to reduce water waste.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-funnel-fill text-info fa-2x me-3"></i>
                                    <div>
                                        <h5 class="mb-1">Water Recycling</h5>
                                        <p class="mb-0">Techniques to reuse and recycle water efficiently.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a class="btn btn-primary rounded-pill py-3 px-5" href="user/login.jsp">Login To Access Tools</a>
                    </div>
                </div>
            </div>
        </div>
