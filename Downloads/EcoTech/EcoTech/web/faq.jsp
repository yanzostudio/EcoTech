<%-- 
    Document   : faq
    Created on : Jan 23, 2025, 12:26:17 AM
    Author     : USER
--%>
    ...
    <body>
        ...
        <div class="container-fluid bg-light py-5">
            <div class="container py-5 text-center">
                ...
                <p class="mb-4">
                    Here are some of the most frequently asked questions. If you need more assistance, feel free to contact us.
                </p>
                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapseOne" class="accordion-collapse collapse show" aria-labelledby="faqHeadingOne" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Energy efficiency refers to using less energy to perform the same task. It's about reducing energy waste while maintaining the same level of service or production.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapseTwo" class="accordion-collapse collapse" aria-labelledby="faqHeadingTwo" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Businesses can improve sustainability by implementing energy-efficient practices, reducing waste, utilizing renewable energy sources, and supporting green technologies.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapseThree" class="accordion-collapse collapse" aria-labelledby="faqHeadingThree" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Carbon tracking involves measuring and recording the amount of carbon dioxide (CO2) emissions generated by an organization or individual, with the aim of reducing their carbon footprint.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapseFour" class="accordion-collapse collapse" aria-labelledby="faqHeadingFour" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        You can contact support by visiting our <a href="contact_us.jsp">Contact Us</a> page, where you can submit a query or reach our support team directly.
                                    </div>
                                </div>
                            </div>
                        </div>
