...
<head>
    ...
    <title>EcoTech - Reources Usage Management</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Resources Usage Management</h1>
                    </div>

        <!-- Card for Resource Usage Filter -->
        <div class="card mb-4">
            <div class="card-header">
                <h4>Filter Resource Usage</h4>
            </div>
            <div class="card-body">
                <form action="ResourceUsageFilterServlet" method="GET">
                    <div class="mb-3">
                        <label for="resourceFilter" class="form-label">Resource</label>
                        <select id="resourceFilter" class="form-select" name="resource_id">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="EditResourceUsageServlet?id=1" class="btn btn-warning">Edit</a>
                                <a href="DeleteResourceUsageServlet?id=1" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <tr>
                            <td>2</td>
                            ...
                            <td>
                                <a href="EditResourceUsageServlet?id=2" class="btn btn-warning">Edit</a>
                                <a href="DeleteResourceUsageServlet?id=2" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
