...
<head>
    ...
    <title>EcoTech - Admin Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="view_metrics.jsp">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Resources Metrics Management</span>
                </a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card-body">
                ...
                <div style="text-align: center;"><!-- Optionally, provide a link to go back to the previous page or to the dashboard -->
                <a href="index.jsp" class="btn btn-primary">Back to Dashboard</a>
                <a href="login.jsp" class="btn btn-secondary">Go to Login</a></div>
            </div>
        </div>
                </div>
                <!-- /.container-fluid -->
