<%-- 
    Document   : contact_us
    Created on : Jan 23, 2025, 12:21:04 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Contact Us</title>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 h-100 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="h-100 overflow-hidden">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.0726466227175!2d101.5347159!3d3.3322297999999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc42b794339aa7%3A0x59243fa1f500b038!2s13%2C%20Jalan%20Desa%209%2F4%2C%20Bandar%20Country%20Homes%2C%2048000%20Rawang%2C%20Selangor!5e0!3m2!1sen!2smy!4v1738234651066!5m2!1sen!2smy" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="d-inline-flex rounded bg-white w-100 p-4">
                                    ...
                                    <div>
                                        <h4>Our Address</h4>
                                        <p class="mb-0">13-1, Jalan Desa 9/4, Bandar Country Homes, 48000 Rawang, Selangor.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-xl-6">
                                <div class="d-inline-flex rounded bg-white w-100 p-4">
                                    ...
                                    <div>
                                        <h4>Email Us</h4>
                                        <p class="mb-0">info@ecotech.com.my</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!--<div class="col-12">
                                <div class="h-100 overflow-hidden">
                                    <iframe class="w-100 rounded" style="height: 400px;" src="https://maps.app.goo.gl/ky7tj8uLST1SwKRi9" 
