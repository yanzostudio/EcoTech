...
<head>
    ...
    <title>EcoTech - Admin Profile</title>
                            ...
                            <div style="width: 100%;">
                                ...
                                <div class="col-xl-12 col-lg-7">
                                    <div class="card shadow mb-4">
                                        <div class="card-body">
                                            <form action="EditProfileAdminServlet" method="POST">
                                                <label for="email">Email Address:</label>
                                                <input type="email" id="email" name="email" class="form-control" value="<%= admin.getEmail() %>" required>

                                                <label for="password">Password:</label>
                                                <input type="password" id="password" name="password" class="form-control" placeholder="Enter new password (leave empty to keep current password)">

                                                <label for="contact">Contact Number:</label>
                                                <input type="text" id="contact" name="contact" class="form-control" value="<%= admin.getContact() %>" required>
