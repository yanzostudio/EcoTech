<%-- 
    Document   : energy_efficiency
    Created on : Jan 23, 2025, 12:25:04 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Energy Efficiency</title>
        ...
        <div class="container-fluid position-relative p-0">
                    ...
                    <div class="navbar-nav ms-2 py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="waste_mgmnt.jspj" class="dropdown-item">Waste Management</a>
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Energy Efficiency</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                        <li class="breadcrumb-item"><a href="sustainabilities.jsp">Sustainability</a></li>
                        <li class="breadcrumb-item active text-primary">Energy Efficiency</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
                ...
                <div class="container py-5 text-center">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <h1 class="display-4 mb-4">Energy Efficiency</h1>
                            <p class="mb-4">
                                Energy efficiency is the key to reducing energy waste, minimizing environmental impact, and ensuring a sustainable future. 
                                By implementing advanced technologies and sustainable practices, we help individuals and organizations achieve optimal energy use while cutting costs.
                            </p>
                            <div class="row text-start">
                                <!-- Highlight 1 -->
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-house-door-fill text-primary fa-2x me-3"></i>
                                        <div>
                                            <h5 class="mb-1">Residential Solutions</h5>
                                            <p class="mb-0">Smart home systems and energy-efficient appliances to reduce household energy consumption.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Highlight 2 -->
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-buildings text-primary fa-2x me-3"></i>
                                        <div>
                                            <h5 class="mb-1">Commercial Solutions</h5>
                                            <p class="mb-0">Custom solutions for energy optimization in office buildings and industries.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Highlight 3 -->
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-graph-up-arrow text-primary fa-2x me-3"></i>
                                        <div>
                                            <h5 class="mb-1">Energy Audits</h5>
                                            <p class="mb-0">Comprehensive energy assessments to identify and address inefficiencies.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Highlight 4 -->
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-recycle text-primary fa-2x me-3"></i>
                                        <div>
                                            <h5 class="mb-1">Renewable Energy Integration</h5>
                                            <p class="mb-0">Seamless integration of solar panels, wind turbines, and other renewable energy sources.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="user/login.jsp">Login To Access Tool</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="leadership.jsp"><i class="fas fa-angle-right me-2"></i> Our Leadership</a>
