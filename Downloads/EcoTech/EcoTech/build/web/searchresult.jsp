<%-- 
    Document   : index
    Created on : Jan 23, 2025, 12:08:24 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Search Result</title>
    ...
    <body>
        ...
        <div class="container-fluid position-relative p-0">
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Search Results</h4>
        ...
        <div class="container-fluid feature bg-light py-5">
            <div class="container py-5" id="search-results">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h4 class="text-uppercase text-primary">Search Results</h4>
                    <h1 class="display-3 text-capitalize mb-3">Your Search Results for "<span id="searchQuery"></span>"</h1>
                </div>
                <div class="row g-3">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-4">
                            ...
                            <a href="sustainabilities.jsp" class="h4 mb-3">Sustainability</a>
                    ...
                    <!-- Repeat similar blocks for each search result -->
                </div>
            </div>
        </div>
        <!-- search resultr End -->
    ...
    <script>
        // Dynamically populate search results based on query
    const searchQuery = new URLSearchParams(window.location.search).get('query');
    document.getElementById('searchQuery').textContent = searchQuery || 'All Features';

    // Example: Replace below array with actual server-side data
    const searchResults = [
        {
            title: 'Sustainability',
            description: 'Implementing eco-friendly practices and innovative solutions ensures a greener future and drives change that has a positive impact on the planet.',
            link: 'sustainabilities.jsp',
            icon: 'fas fa-leaf'
        },
        {
            title: 'Customers',
            description: 'Our customers are at the heart of sustainability implementation through several case studies, testimonials and comprehensive support.',
            link: 'customers.jsp',
            icon: 'fas fa-user-tie'
        },
        {
            title: 'Support',
            description: 'With a strong vision and dedicated leadership in innovation, we committed to supporting the community by implementing sustainable practices.',
            link: 'support.jsp',
            icon: 'fas fa-hands-helping'
        },
        {
            title: 'About',
            description: 'Our journey is driven by a mission to inspire positive change through innovative practices, strategic collaborations, and environmental stewardship.',
            link: 'about.jsp',
            icon: 'fas fa-building'
        }
    ];

    const resultsContainer = document.querySelector('.row.g-3');
    resultsContainer.innerHTML = ''; // Clear initial content

    searchResults.forEach(result => {
        const resultHTML = `
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="feature-item p-4">
                    <div class="feature-icon mb-3"><i class="${result.icon} text-white fa-3x"></i></div>
                    <a href="${result.link}" class="h4 mb-3">${result.title}</a>
                    <p class="mb-3">${result.description}</p>
                    <a href="${result.link}" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                </div>
            </div>
        `;
