<%-- 
    Document   : casestudy
    Created on : Jan 23, 2025, 12:19:37 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Case Study</title>
    ...
    <body>
        ...
        <div class="container-fluid position-relative p-0">
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Case Study</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                        <li class="breadcrumb-item"><a href="customers.jsp">Customers</a></li>
                        <li class="breadcrumb-item active text-primary">Case Study</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
        ...
        <div class="container-fluid bg-light py-2">
            <div class="container py-5 text-center">
                <!--<h2 class="display-4 mb-4">Case Studies</h2>
                <p class="mb-4">
                    Discover how businesses and organizations are achieving sustainability through innovative solutions.
                </p>-->
                <div class="row justify-content-center">
                    <!-- Case Study 1 -->
                    <div class="col-md-4 mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card shadow-lg border-0">
                            <img src="img/casestudy-1.jpg" class="card-img-top" alt="Case Study 1">
                            <div class="card-body">
                                <h5 class="card-title">Residential Energy Efficiency</h5>
                                <p class="card-text">
                                    A home renovation project focused on reducing energy consumption through the installation of energy-efficient appliances and smart home systems.
                                </p>
                    ...
                    <div class="col-md-4 mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card shadow-lg border-0">
                            <img src="img/casestudy-2.jpg" class="card-img-top" alt="Case Study 2">
                            <div class="card-body">
                                <h5 class="card-title">Commercial Carbon Reduction</h5>
                                <p class="card-text">
                                    A commercial office building that successfully reduced its carbon footprint by 30% in one year through renewable energy integration and optimization.
                                </p>
                                <a href="#" class="btn btn-primary">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card shadow-lg border-0">
                            <img src="img/casestudy-3.jpg" class="card-img-top" alt="Case Study 3">
                            <div class="card-body">
                                <h5 class="card-title">Water Conservation in Agriculture</h5>
                                <p class="card-text">
                                    An agricultural project focused on water conservation using smart irrigation systems to reduce water consumption and improve crop yield.
                                </p>
                                <a href="#" class="btn btn-primary">Read More</a>
                            </div>
                        </div>
