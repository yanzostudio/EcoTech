<%-- 
    Document   : tnc
    Created on : Jan 23, 2025, 12:43:55 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Terms & Condition</title>
        ...
        <div class="container-fluid position-relative p-0">
                    ...
                    <div class="navbar-nav ms-2 py-0">
                        ...
                        <!--<div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <!--<a href="media.jsp" class="dropdown-item">Media</a>
                            </div>
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Terms & Condition</h4>
...
<div class="container-fluid feature bg-light py-5">
    <div class="container py-5">
        ...
        <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <p>By using our platform, you agree to comply with the following terms and conditions. Please read them carefully.</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.4s">
                <h4 class="text-primary">1. General Use</h4>
                <p>Our platform provides sustainability management tools for personal and business use. Users are expected to adhere to all applicable laws and regulations while using the platform.</p>
            </div>

            <!-- Section 2 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.6s">
                <h4 class="text-primary">2. Privacy Policy</h4>
                <p>We value your privacy. All personal information collected on this platform is handled in accordance with our <a href="privacy_policy.jsp" class="text-primary">Privacy Policy</a>.</p>
            </div>

            <!-- Section 3 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.8s">
                <h4 class="text-primary">3. User Responsibilities</h4>
                <p>Users are responsible for maintaining the security of their accounts and ensuring all provided data is accurate and up-to-date.</p>
            </div>

            <!-- Section 4 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="1s">
                <h4 class="text-primary">4. Limitation of Liability</h4>
                <p>We strive to provide accurate information, but we are not responsible for any damages or losses resulting from the use of our platform.</p>
            </div>

            <!-- Section 5 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="1.2s">
                <h4 class="text-primary">5. Amendments</h4>
                <p>We reserve the right to update these terms at any time. Changes will be communicated through our platform or via email.</p>
            </div>

            <!-- Section 6 -->
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="1.4s">
                <h4 class="text-primary">6. Contact Us</h4>
                <p>If you have any questions or concerns regarding these terms, feel free to <a href="contact_us.jsp" class="text-primary">Contact Us</a>.</p>
            </div>
        </div>
    </div>
</div>
