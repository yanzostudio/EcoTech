<%-- 
    Document   : customers
    Created on : Jan 23, 2025, 12:23:27 AM
    Author     : USER
--%>
        ...
        <div class="container-fluid position-relative p-0">
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Customers</h4>
        ...
        <div class="row justify-content-center align-items-center g-5">
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="feature-item p-4">
                    ...
                    <a href="#" class="h4 mb-3">Case Study</a>
                    <p class="mb-3">Explore real-world success stories where our solutions have transformed sustainability goals into successful measurable results.</p>
                    <a href="casestudy.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                </div>
            </div>
            <!--<div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="feature-item p-4">
                    <div class="feature-icon mb-3"><i class="fas fa-user-check text-white fa-3x"></i></div>
                    <a href="#" class="h4 mb-3">Testimonials</a>
                    <p class="mb-3">Hear directly from our clients about their journey toward sustainable practices to align with their environmental responsibilities.</p>
                    <a href="carbon_tracking.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                </div>
            </div>-->
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="feature-item p-4">
                    <div class="feature-icon mb-3"><i class="fas fa-question text-white fa-3x"></i></div>
                    <a href="#" class="h4 mb-3">FAQ</a>
                    <p class="mb-3">Find answers to common questions about implementing and maintaining sustainable practices to provides clarity on topics like renewable energy.</p>
                    <a href="faq.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
    </div>
