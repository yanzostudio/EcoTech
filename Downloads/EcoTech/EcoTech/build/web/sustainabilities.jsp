<%-- 
    Document   : sustainabilities
    Created on : Jan 23, 2025, 12:40:15 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Sustainability</title>
        ...
        <div class="container-fluid position-relative p-0">
                    ...
                    <div class="navbar-nav ms-2 py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <!--<a href="testimonials.jsp" class="dropdown-item">Testimonials</a>-->
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Sustainability</h4>
                    ...
                    <div class="row g-4">
                        <div class=" col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-solar-panel text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Energy Efficiency</a>
                                <p class="mb-3">Maximizing energy savings through smarter technologies, efficient designs, and renewable energy integration to reduce carbon footprints.</p>
                                <a href="energy_efficiency.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-cloud text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Carbon Tracking</a>
                                <p class="mb-3">Providing tools and insights to measure and manage carbon emissions, empowering industries to align with global sustainability goals.</p>
                                <a href="carbon_tracking.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-recycle text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Waste Management</a>
                                <p class="mb-3">Innovative solutions to reduce, reuse, and recycle waste, creating a circular economy that benefits businesses and communities alike.</p>
                                <a href="waste_mgmnt.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                            <div class="feature-item p-4">
                                <div class="feature-icon mb-3"><i class="fas fa-hand-holding-water text-white fa-3x"></i></div>
                                <a href="#" class="h4 mb-3">Water Conservation</a>
                                <p class="mb-3">Promoting sustainable water management practices to ensuring long-term availability of ecosystem</p>
                                <a href="water_conservation.jsp" class="btn text-secondary">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
