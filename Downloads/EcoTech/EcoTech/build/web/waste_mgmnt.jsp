<%-- 
    Document   : water_mgmnt
    Created on : Jan 23, 2025, 12:45:35 AM
    Author     : USER
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>EcoTech - Waste Management</title>
        ...
        <div class="container-fluid position-relative p-0">
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Waste Management</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                        <li class="breadcrumb-item"><a href="sustainabilities.jsp">Sustainability</a></li>
                        <li class="breadcrumb-item active text-primary">Waste Management</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
                ...
                <div class="container py-5 text-center">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                            <i class="fas fa-trash display-1 text-success"></i>
                            <h1 class="display-4 mb-4">Waste Management</h1>
                            <p class="mb-4">
                                Effective waste management helps minimize environmental pollution and ensures proper resource utilization. 
                                Discover innovative solutions to manage and reduce waste efficiently.
                            </p>
                            <div class="row text-start justify-content-center">
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-recycle text-success fa-2x me-3"></i>
                                        <div>
                                            <h5 class="mb-1">Recycling Programs</h5>
                                            <p class="mb-0">Initiatives to sort, recycle, and reuse materials effectively.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-1">Composting Solutions</h5>
                                            <p class="mb-0">Methods for organic waste conversion to valuable compost.</p>
                                        </div>
                                    </div>
                                </div>
